    ...
    <div class="board-writer">
        ...
        <div class="section app-content-window">
            ...
            <ul class="search">
                ...
                <li class="search-list" v-for="(item, i) in resultData">
        ...
        <input type="checkbox" name="" id="opener" v-model="isWindowOpened">
        <label for="opener"><i class="fa-light fa-up-right-from-square"></i></label>
    </div>
    <div id="map"></div>
