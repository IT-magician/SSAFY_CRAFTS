...
if (selectedTheme) {
  ...
  document
    .querySelector("#place")
    .querySelector(".place_container")
    .classList[selectedTheme === "dark" ? "add" : "remove"]("dark-theme-box-shadow");
...
themeButton.addEventListener("click", () => {
  ...
  document.querySelector("#place").querySelector(".place_container").classList.toggle("dark-theme-box-shadow");
