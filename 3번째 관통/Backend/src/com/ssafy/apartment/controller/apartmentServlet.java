...
//              System.out.println("stringfy json + " + list.toString());
            ...
            case "syncCheckbox":
            {
            	ArrayList<String> list1 = dao.getUserFavorSync(request.getParameter("id"),request.getParameter("code"));
            ...
            {
            	dao.insertFavApt(request.getParameter("id"), request.getParameter("code"), request.getParameter("dong"));
...
////            	System.out.println("insert");
            ...
            {
            	dao.deleteFavApt(request.getParameter("id"), request.getParameter("code"), request.getParameter("dong"));
...
////            	System.out.println("delete");
            ...
            {
            	list = dao.getUserFavorApartments(request.getParameter("id"));
            	response.getWriter().write(list.toString());
            }
            	break;
