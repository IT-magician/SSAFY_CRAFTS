...
function updateUserFavor(){
      ...
      xhr.open("get", `./selectApartment.apartmentServlet?id=${document.querySelector(".header_nav .header_nav_right form").querySelector("label").innerHTML}`, false);
	  xhr.send(null);
...
document
  ...
  .addEventListener("click", async function () {
    ...
    await fetch(`./getApartment.apartmentServlet?sVal=${sVal?sVal:null }&gVal=${gVal?gVal:null }&dVal=${dVal!="동선택"?dVal:null }`)
